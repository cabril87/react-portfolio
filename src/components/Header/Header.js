    ...
    return (
        ...
        >
            <div className="flex flex-col items-center justify-center md:flex-row-reverse md:w-10/12 md:justify-between">
                <div
                    className="w-full md:w-2/5 shadow-inner... shadow-2xl" >
                    <LazyLoadImage
                ...
                <div className="text-white font-dosis w-full md:w-3/5 text-center  ">
                    <h2
                    ...
                    <h1 className={`text-2xl md:text-4xl text-gray-400 transform ${animated ? 'translate-y-0' : styleTranslate
                        } ${transition(3000)} `}>{content.header.text[2]}
                        <Typical
