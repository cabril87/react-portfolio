    ...
    >
      ...
      <div className="flex items-center min-h-screen  dark:bg-gray-900">
        <div className="container mx-auto ">
          <div className="w-80 mx-auto my-10 bg-white p-5 rounded-md shadow-sm h-2/3 ">
            <div className="text-center">
              <h1 className="my-3 text-3xl font-semibold text-gray-700 dark:text-gray-200">Call Me Maybe!</h1>
